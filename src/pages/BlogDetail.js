...
const BlogDetail = () => {
  ...
  async function fetchNewBlog(id) {
    try {
      fetchData(`${url}/blog/${id}`, console.log, (data) => {
        setData(data.data);
      });
    } catch (error) {
      console.log(error);
        ...
        <div className="container mx-auto overflow-hidden px-4 sm:px-8 md:px-16 lg:px-28">
          <div className="flex flex-col items-center justify-center lg:flex-row mt-4 sm:mt-6">
            <div className="flex-1 p-4 sm:p-6 md:p-10 m-4 sm:m-6">
              <div>
                <h2 className="text-4xl sm:text-6xl mt-2 sm:mt-4 capitalize">
                  {data.title}
                </h2>
              </div>
              <div className="flex items-center gap-4 mt-8">
                <div className="w-[6%]">
                  <img
                    ...
                    src={avatars[data.avatar] || avatars["anon"]}
                    alt=""
                  />
                </div>
                <div>
          ...
          <div className="flex-[3]">
            ...
            <div className="mt-10">
              ...
              <div className="flex items-center mb-4">
                ...
                <button
                  onClick={() => {
                    if (comment.length > 0) setShowCommentBox(true);
                  }}
